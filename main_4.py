...
def main():
    global running, time, fire, level_1, level_3, level_2, player, time_level, boss_level, nps
    while running:
        num = player.hp
        if float(num) <= 0.0:
            running = False
                        ...
                        if not boss_level and not time_level:
                            if nps.player and nps.number < 7:
                                ...
                                for i in range(70):
                                    ...
                                    clock.tick(FPS)
                                    pygame.display.flip()
                        if nps.fountain or time_level or boss_level:
                            if not boss_level:
                                for i in red_fountain:
                                    if i.player:
